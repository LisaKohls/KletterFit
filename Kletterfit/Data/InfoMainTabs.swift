//
//  InfoFitnessIcons.swift
//  Kletterfit
//
//  Created by Jana Eichholz on 09.05.23.
//

import Foundation
import SwiftUI

struct InfoMainTabs: Identifiable {
...
var infoFitnessIcons = [
InfoMainTabs(name: "Statistics", destination: AnyView(StatisticClimbing()), gradient: LinearGradient(
...
InfoMainTabs(name: "Trainings", destination: AnyView(TrainingOverView()), gradient: LinearGradient(
    gradient: Gradient(stops: [
...
.init(color: Color(#colorLiteral(red: 0.75, green: 0.12187504768371582, blue: 0.12187504768371582, alpha: 0.6100000143051147)), location: 0.7778382897377014)]),
    startPoint: UnitPoint(x: -1.1102230246251565e-16, y: 0),
    endPoint: UnitPoint(x: 1.0000000149011612, y: 1.000000014901162))),
InfoMainTabs(name: "Exercises", destination: AnyView(ExerciseOverView()), gradient: LinearGradient(
    gradient: Gradient(stops: [
